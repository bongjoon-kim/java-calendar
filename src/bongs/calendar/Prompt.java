...
public class Prompt {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (sel.equals("1")) savePlan(sc, cal);
			else if (sel.equals("2")) searchPlan(sc, cal);
			else if (sel.equals("3")) CalendarPrint(sc, cal);	
			else if (sel.equals("h")) printMenu();
			else if (sel.equals("q")) break;
			else
